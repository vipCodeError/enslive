                                    ...
                                    @if($loop->index < 8 & $news_c->news_title != "")
                                        <h4 style="margin-right: 16px">
                                            <i class="fa fa-circle"
                                               style="color: red; padding-right: 8px; font-size: 12px;">
                                            </i><a href="{{route('show_web', [$news_c->edition_slug, $news_c->id ])}}"
                                                   style="font-size: 17px">{{$news_c->news_title}}</a>
                                        </h4>
                                    @endif
                                @endforeach
                            </div>
                                    ...
                                    @if($loop->index == 0)
                                        <div class="carousel-item active">
                                            ...
                                            <div class="carousel-caption d-none d-md-block">
                                                <a href="{{route('show_web',[$news_c->edition_slug, $news_c->id ])}}"
                                                   title="{{ $news_c->news_title }}"><h3>{{$news_c->news_title}}</h3>
                                                </a>
                                            </div>
                                        </div>
                                    @else
                                        <div class="carousel-item">
                                            <img class="d-block w-100"
                                                 ...
                                                 alt="First slide">
                                            <div class="carousel-caption d-none d-md-block">
                                                <a href="{{route('show_web', [$news_c->edition_slug, $news_c->id ])}}"><h3>{{$news_c->news_title}}</h3></a>
                                    </div>
                                </div>
                                @endif
                                                   @endif
...
{{--            <div class="row"--}}
                                                    ...
                                                    <div class="select_district_option">
                                                        <div class="row">
                                                            ...
                                                            <div class="s_district_andra">
                                                                <label for="FormControlSelectDistrictAndra">Select
                                                                    District</label>
                                                                <select class="form-control"
                                                                        id="FormControlSelectDistrictAndra">
                                                            ...
                                                            <div class="s_district_telegana">
                                                                <label for="FormControlSelectDistrictTelegana">Select
                                                                    District</label>
                                                                <select class="form-control"
                                                                        id="FormControlSelectDistrictTelegana">
                                                ...
                                                <div class="horoscope_dt" style="position: relative;">
                                                    <img src="{{asset('public/img/horoscope_new.jpeg')}}" width="100%"
                                                         height="100%"
                                                    ...
                                                    <div class="full_img_static"
                                                        ...
                                                        <div id="demo1" class="carousel slide" data-ride="carousel">
                                                            ...
                                                            <ul class="carousel-indicators">
                                                                <li data-target="#demo1" data-slide-to="0"
                                                                    class="active"></li>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                        ...
                        @if($loop->index == 0)
                            <div class="big_picture">
                                @if($mandal->photos_vid != "")
                                    <a href="{{route('show_web', [$mandal->edition_slug, $mandal->id ])}}"><img
                            ...
                            <div class="list_news_card">
                                <div class="news_card_list">
                                    ...
                                    <div class="news_title_list">
                                        <a href="{{route('show_web', [$mandal->edition_slug, $mandal->id ])}}">
                                            <h6>{{$mandal->news_title}}</h6>
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="view_more" style="margin-top:10px">
                        <a href="{{route('cat_show_news', 'Mandal')}}">
                            <h7>View More</h7>
                        </a>
                    </div>
                ...
                <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                    ...
                    @foreach($state_news as $state)
                        @if($loop->index == 0)
                            <div class="big_picture">
                                <a href="{{route('show_web', [$state->edition_slug, $state->id ])}}"><img
                        ...
                        @else
                            <div class="list_news_card">
                                <div class="news_card_list">
                                    ...
                                    <div class="news_title_list">
                                        <a href="{{route('show_web', [$state->edition_slug, $state->id ])}}">
                    ...
                    <div class="view_more" style="margin-top:10px">
                        <a href={{route('cat_show_news', 'State')}}>
                            <h7>View More</h7>
                        </a>
                    </div>
                ...
                <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                    ...
                    @foreach($national_news as $national)
                        @if($loop->index == 0)
                            <div class="big_picture">
                                <a href="{{route('show_web', [$national->edition_slug, $national->id ])}}"><img
                        ...
                        @else
                            <div class="list_news_card">
                                <div class="news_card_list">
                                    ...
                                    <div class="news_title_list">
                                        <a href="{{route('show_web', [$national->edition_slug, $national->id ])}}">
                                            <h6>{{$national->news_title}}</h6>
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="view_more" style="margin-top:10px">
                        <a href="{{route('cat_show_news', 'National')}}">
                            <h7>View More</h7>
                        </a>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                    ...
                    @foreach($district_news as $district)
                        @if($loop->index == 0)
                            <div class="big_picture">
                                <a href="{{route('show_web', [$district->edition_slug, $district->id ])}}"><img
                        ...
                        @else
                            <div class="list_news_card">
                                <div class="news_card_list">
                                    ...
                                    <div class="news_title_list">
                                        <a href="{{route('show_web', [$district->edition_slug, $district->id ])}}">
                                            <h6>{{$district->news_title}}</h6>
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="view_more" style="margin-top:10px">
                        <a href="{{route('cat_show_news', 'District')}}">
                            <h7>View More</h7>
                        </a>
                    </div>
                ...
                <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                        ...
                        @if($loop->index == 0)
                            <div class="big_picture">
                                @if($world->photos_vid == null || str_contains($world->photos_vid, 'upload'))
                                    <a href="{{route('show_web', [$world->edition_slug, $world->id ])}}"><img
                                            src="https://socialistmodernism.com/wp-content/uploads/2017/07/placeholder-image.png"
                                            width="100%" height="200px"></a>

                                @else
                                    <a href=""><img
                                            src="https://d4f9k68hk754p.cloudfront.net/fit-in/300x400/{{$world->photos_vid}}"
                                            width="100%" height="200px"></a>
                                @endif
                        ...
                        @else
                            <div class="list_news_card">
                                <div class="news_card_list">
                                    <div class="small_picture">
                                        @if($world->photos_vid == null || str_contains($world->photos_vid, 'upload'))
                                            <a href="{{route('show_web', [$world->edition_slug, $world->id ])}}">
                                                <a href=""><img
                                                        src="https://socialistmodernism.com/wp-content/uploads/2017/07/placeholder-image.png"
                    ...
                    <div class="view_more" style="margin-top:10px">
                        <a href="{{route('cat_show_news', 'World')}}">
                            <h7>View More</h7>
                        </a>
                    </div>
                ...
                <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                    ...
                    @foreach($history_news as $history)
                        @if($loop->index == 0)
                            <div class="big_picture">
                                <a href="{{route('show_web', [$history->edition_slug, $history->id ])}}"><img
                                ...
                                <div class="news_card_list">
                                    <div class="small_picture">
                                        @if($history->photos_vid == null || str_contains($history->photos_vid, 'upload'))
                                            <a href="{{route('show_web', [$history->edition_slug, $history->id ])}}">
                                                <a href=""><img
                                                        src="https://socialistmodernism.com/wp-content/uploads/2017/07/placeholder-image.png"
                                                        width="120x" height="70px"></a>
                    ...
                    <div class="view_more" style="margin-top:10px">
                        <a href="{{route('cat_show_news', 'History')}}">
                            <h7>View More</h7>
                        </a>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                    ...
                    @foreach($tourism_news as $tourism)
                        @if($loop->index == 0)
                            <div class="big_picture">
                                <a href="{{route('show_web', [$tourism->edition_slug, $tourism->id ])}}"><img
                                ...
                                <div class="news_card_list">
                                    <div class="small_picture">
                                        @if($tourism->photos_vid == null || str_contains($tourism->photos_vid, 'upload'))
                                            <a href="{{route('show_web', [$tourism->edition_slug, $tourism->id ])}}">
                                                <a href=""><img
                                                        src="https://socialistmodernism.com/wp-content/uploads/2017/07/placeholder-image.png"
                                                        width="120x" height="70px"></a>
                    ...
                    <div class="view_more" style="margin-top:10px">
                        <a href="{{route('cat_show_news', 'Tourism')}}">
                            <h7>View More</h7>
                        </a>
                    </div>
                ...
                <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                    ...
                    @foreach($health_news as $health)
                        @if($loop->index == 0)
                            <div class="big_picture">
                                <a href="{{route('show_web', [$health->edition_slug, $health->id ])}}"><img
                        ...
                        @else
                            <div class="list_news_card">
                                <div class="news_card_list">
                                    ...
                                    <div class="news_title_list">
                                        <a href="{{route('show_web', [$health->edition_slug, $health->id ])}}">
                                            <h6>{{$health->news_title}}</h6>
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="view_more" style="margin-top:10px">
                        <a href="{{route('cat_show_news', 'Health')}}">
                            <h7>View More</h7>
                        </a>
                    </div>
                ...
                <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                    ...
                    @foreach($business_news as $business)
                        @if($loop->index == 0)
                            <div class="big_picture">
                                ...
                                @else
                                    <a href="{{route('show_web', [$business->edition_slug, $business->id ])}}"><img
                        ...
                        @else
                            <div class="list_news_card">
                                <div class="news_card_list">
                                    <div class="small_picture">
                                        @if($business->photos_vid == null || str_contains($business->photos_vid, 'upload'))
                                            <a href="{{route('show_web', [$business->edition_slug, $business->id ])}}">
                                                <a href=""><img
                                                        src="https://socialistmodernism.com/wp-content/uploads/2017/07/placeholder-image.png"
                                                        width="120x" height="70px"></a>
                    ...
                    <div class="view_more" style="margin-top:10px">
                        <a href="{{route('cat_show_news', 'Business')}}">
                            <h7>View More</h7>
                        </a>
                    </div>
        ...
        <div class="mandal_state_national_card_news" style="margin-top: 24px;">
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                        ...
                        @else
                            <div class="list_news_card">
                                <div class="news_card_list">
                                    ...
                                    <div class="news_title_list">
                                        <a href="{{route('show_web', [$ens->edition_slug, $ens->id ])}}">
                                            <h6>{{$ens->news_title}}</h6>
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="view_more" style="margin-top:10px">
                        <a href="{{route('cat_show_news', 'ENS')}}">
                            <h7>View More</h7>
                        </a>
                    </div>
                ...
                <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                    ...
                    @foreach($crime_news as $crime)
                        @if($loop->index == 0)
                            <div class="big_picture">
                                <a href="{{route('show_web', [$crime->edition_slug, $crime->id ])}}"><img
                        ...
                        @else
                            <div class="list_news_card">
                                <div class="news_card_list">
                                    ...
                                    <div class="news_title_list">
                                        <a href="{{route('show_web', [$crime->edition_slug, $crime->id ])}}">
                                            <h6>{{$crime->news_title}}</h6>
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="view_more" style="margin-top:10px">
                        <a href="{{route('cat_show_news', 'Crime')}}">
                            <h7>View More</h7>
                        </a>
                    </div>
                ...
                <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                    ...
                    @foreach($political_news as $political)
                        @if($loop->index == 0)
                            <div class="big_picture">
                                ...
                                @else
                                    <a href="{{route('show_web', [$political->edition_slug, $political->id ])}}"><img
                        ...
                        @else
                            <div class="list_news_card">
                                <div class="news_card_list">
                                    ...
                                    <div class="news_title_list">
                                        <a href="{{route('show_web', [$political->edition_slug, $political->id ])}}">
                                            <h6>{{$political->news_title}}</h6>
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="view_more" style="margin-top:10px">
                        <a href="{{route('cat_show_news', 'Political')}}">
                            <h7>View More</h7>
                        </a>
                    </div>
        ...
        <div class="mandal_state_national_card_news" style="margin-top: 24px;">
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                        ...
                        @else
                            <div class="list_news_card">
                                <div class="news_card_list">
                                    ...
                                    <div class="news_title_list">
                                        <a href="{{route('show_web', [$job->edition_slug, $job->id ])}}">
                                            <h6>{{$job->news_title}}</h6>
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="view_more" style="margin-top:10px">
                        <a href="{{route('cat_show_news', 'Job')}}">
                            <h7>View More</h7>
                        </a>
                    </div>
                ...
                <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                    ...
                    @foreach($humanity_news as $humanity)
                        ...
                        @else
                            <div class="list_news_card">
                                <div class="news_card_list">
                                    <div class="small_picture">
                                        <a href="{{route('show_web', [$humanity->edition_slug, $humanity->id ])}}"><img
                                                src="https://d4f9k68hk754p.cloudfront.net/fit-in/300x400/{{$humanity->photos_vid}}"
                                                width="100px" height="70px"></a>
                                    </div>

                                    <div class="news_title_list">
                                        <a href="{{route('show_web', [$humanity->edition_slug, $humanity->id ])}}">
                                            <h6>{{$humanity->news_title}}</h6>
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="view_more" style="margin-top:10px">
                        <a href="{{route('cat_show_news', 'Humanity')}}">
                            <h7>View More</h7>
                        </a>
                    </div>
                ...
                <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                    ...
                    @foreach($cinema_news as $cinema)
                        @if($loop->index == 0)
                            <div class="big_picture">
                                ...
                                @else
                                    <a href="{{route('show_web', [$cinema->edition_slug, $cinema->id ])}}"><img
                        ...
                        @else
                            <div class="list_news_card">
                                <div class="news_card_list">
                                    ...
                                    <div class="news_title_list">
                                        <a href="{{route('show_web', [$cinema->edition_slug, $cinema->id ])}}">
                                            <h6>{{$cinema->news_title}}</h6>
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="view_more" style="margin-top:10px">
                        <a href="{{route('cat_show_news', 'Cinema')}}">
                            <h7>View More</h7>
                        </a>
                    </div>
        ...
        <div class="mandal_state_national_card_news" style="margin-top: 24px;">
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                        ...
                        @if($loop->index == 0)
                            <div class="big_picture">
                                @if($kitchen->photos_vid == null || str_contains($kitchen->photos_vid, 'upload'))
                                    ...
                                    <a href="{{route('show_web', [$kitchen->edition_slug, $kitchen->id ])}}"><img
                                            src="https://socialistmodernism.com/wp-content/uploads/2017/07/placeholder-image.png"
                        ...
                        @else
                            <div class="list_news_card">
                                <div class="news_card_list">
                                    <div class="small_picture">
                                        @if($kitchen->photos_vid == null || str_contains($kitchen->photos_vid, 'upload'))
                                            <a href="{{route('show_web', [$kitchen->edition_slug, $kitchen->id ])}}">
                                                <a href=""><img
                                                        src="https://socialistmodernism.com/wp-content/uploads/2017/07/placeholder-image.png"
                                                        width="120x" height="70px"></a>
                    ...
                    <div class="view_more" style="margin-top:10px">
                        <a href="{{route('cat_show_news', 'Kitchen')}}">
                            <h7>View More</h7>
                        </a>
                    </div>
                ...
                <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                    ...
                    @foreach($sports_news as $sports)
                        @if($loop->index == 0)
                            <div class="big_picture">
                                <a href="{{route('show_web', [$sports->edition_slug, $sports->id ])}}"><img
                                ...
                                <div class="news_card_list">
                                    <div class="small_picture">
                                        @if($sports->photos_vid == null || str_contains($sports->photos_vid, 'upload'))
                                            <a href="{{route('show_web', [$sports->edition_slug, $sports->id ])}}">
                                                <a href=""><img
                                                        src="https://socialistmodernism.com/wp-content/uploads/2017/07/placeholder-image.png"
                                                        width="120x" height="70px"></a>
                    ...
                    <div class="view_more" style="margin-top:10px">
                        <a href="{{route('cat_show_news', 'Sports')}}">
                            <h7>View More</h7>
                        </a>
                    </div>
                ...
                <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                    ...
                    @foreach($videos_news as $videos)
                        @if($loop->index == 0)
                            <div class="big_picture">
                                ...
                                @else
                                    <video width="320" height="240" disabled>
                                        <source
                                            src="https://d4f9k68hk754p.cloudfront.net/fit-in/300x400/{{$videos->photos_vid}}"
                                            type="video/mp4">
                                    </video>
                                    <a href="{{route('show_web', [$videos->edition_slug, $videos->id ])}}"><img
                                            src=""
                                            width="100%" height="200px"></a>
                                @endif
                                <div class="bottom_banner">
                        ...
                        @else
                            <div class="list_news_card">
                                <div class="news_card_list">
                                    <div class="small_picture">
                                        @if($videos->photos_vid == null || str_contains($videos->photos_vid, 'upload'))
                                            <a href="{{route('show_web', [$videos->edition_slug, $videos->id ])}}">
                                                <a href=""><img
                                                        src="https://socialistmodernism.com/wp-content/uploads/2017/07/placeholder-image.png"
                                                        width="120x" height="70px"></a>
                    ...
                    <div class="view_more" style="margin-top:10px">
                        <a href="{{route('cat_show_news', 'Video')}}">
                            <h7>View More</h7>
                        </a>
                    </div>
