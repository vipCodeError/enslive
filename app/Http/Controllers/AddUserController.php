...
class AddUserController extends Controller
{
    ...
    {
        return view('admin_panel.useradd.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $user->user_type = $request->is_admin_select;
        $user->save();

        return redirect()->route("add_user.index")->with('success','New User Created successfully!');
    }
